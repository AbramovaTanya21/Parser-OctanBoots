...
ChromedriverPuth = "G:\\Applications\\Selenium\\Chrome_draver\\chromedriver-win64\\chromedriver.exe"
CollectionFilePath = "G:\\Program Proects\\Parsers\\Parser_OceanBoots\\Parser_OceanBoots\\Catalog_OceanBoots.xlsx"
...
def RecordingToExcel(Goods,CollectionName): 
    ...
    for index, item in enumerate(Goods, start = 2 ):  
        ...
        ws.cell(row=index, column=6).alignment = Alignment(wrap_text=True)
